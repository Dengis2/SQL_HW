...
CREATE TABLE products (
  ...
  desription VARCHAR(255) COMMENT 'Описание',
...
USE shop;
CREATE VIEW prod_des AS SELECT products.name 
AS product, catalogs.name 
AS catalog FROM products
LEFT JOIN catalogs 
ON products.catalog_id = catalogs.id;

SELECT * FROM prod_des;
